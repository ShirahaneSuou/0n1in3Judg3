...
--
-- Table structure for table `VJ_Solution`
--

DROP TABLE IF EXISTS `VJ_Solution`;
...
--
-- Dumping data for table `VJ_Solution`
--

LOCK TABLES `VJ_Solution` WRITE;
/*!40000 ALTER TABLE `VJ_Solution` DISABLE KEYS */;
/*!40000 ALTER TABLE `VJ_Solution` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-12-20 17:37:24
